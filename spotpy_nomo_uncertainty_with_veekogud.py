...
class nomo_spotpy_setup(object):
    def __init__(self, observed_data_src, param_defs, parallel="seq", temp_dir=None, pzone=21):
        ...
        self.observed_data = self.prep_observed_data()
    

    def prep_observed_data(self, observed_data_src, temp_dir, initial_obs_clearing):
        input_params = { 
...
def main(argv):
    ...
    observed_data_src =  { 'dest_fname' : os.path.join("/gpfs/hpc/home/kmoch/nomo_kik", f"QGIS_OUTPUT_BUF_SIZE_{pzone}.tif"),
            ...
            'poly_clipper' : os.path.join("/gpfs/hpc/home/kmoch/nomo_kik", f"veekaitsekonnd_dis_{pzone}.gpkg") }
    ...
    lhs_sampler = spotpy.algorithms.lhs(get_ready, parallel=parallel, dbname=f"nomo_uncert_clipped_lhs_zone_{pzone}", dbformat=dbformat, save_sim=True)
