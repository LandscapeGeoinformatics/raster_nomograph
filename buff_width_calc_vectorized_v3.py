...
if __name__ == '__main__':
    ...
    input_params = { 
                    'INPUT_SLOPE' : r'//rocket.hpc.ut.ee/gis/HannaIngrid/5m_calc/zone_21_slope_5m.tif',
                    'INPUT_FLOW_LENGTH' : r'//rocket.hpc.ut.ee/gis/HannaIngrid/5m_calc/zone_21_flowlength_5m.tif',
