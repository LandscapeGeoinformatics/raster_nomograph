...
# work_path = r'\\rocket.hpc.ut.ee\gis\Evelyn\veekaitsevoondid\valgjarve_test\1m'
work_path = r'c:/dev/05_geodata/qgis_map_projects/kik_project'


slope_raster_in = os.path.join(work_path, 'slope_1m_valgjarve.tif')

slope_len_raster_in = os.path.join(work_path, 'slope_length_1m_valgjarve.tif')

soil_class_raster_in = os.path.join(work_path, 'soil_1_valgjarve.tif')

# buff_width_raster_out = os.path.join(work_path, 'buffer_strip_width_1m_valgjarve.tif')
